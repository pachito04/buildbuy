export const PROVINCIAS: Record<string, string[]> = {
  "Buenos Aires": [
    ...
    "General Guido", "General La Madrid", "General Las Heras", "General Lavalle",
    "General Madariaga", "General Paz", "General Pinto", "General Pueyrredón",
    "General Rodríguez", "General San Martín", "General Viamonte", "General Villegas",
    "Hurlingham", "Ituzaingó", "José C. Paz", "Junín", "La Costa",
    "La Matanza", "La Plata", "Lanús", "Laprida", "Las Flores",
    ...
    "Pila", "Pilar", "Pinamar", "Presidente Perón", "Puan",
    ...
    "San Vicente", "Suipacha", "Tandil", "Tapalqué", "Tigre",
    "Tordillo", "Tornquist", "Trenque Lauquen", "Tres Arroyos", "Tres de Febrero",
    "Tres Lomas", "Veinticinco de Mayo", "Vicente López", "Villa Gesell",
    "Villarino", "Zárate",
  ],
  ...
  "Catamarca": [
    ...
    "Belén", "Capayán", "Capital", "El Alto", "Fray Mamerto Esquiú",
    "La Paz", "Paclín", "Pomán", "Santa María", "Santa Rosa",
  ...
  "Chaco": [
    ...
    "General Belgrano", "General Donovan", "General Güemes",
    "Independencia", "Libertad", "Libertador General San Martín",
    "Maipú", "Mayor Luis J. Fontana", "Nueve de Julio", "O'Higgins",
    "Presidencia de la Plaza", "Primero de Mayo", "Quitilipi",
    "San Fernando", "San Lorenzo", "Sargento Cabral", "Tapenagá",
    "Veinticinco de Mayo",
  ],
  "Chubut": [
    "Biedma", "Cushamen", "Escalante", "Florentino Ameghino",
  ...
  "Córdoba": [
    ...
    "Río Cuarto", "Río Primero", "Río Segundo", "Río Seco",
    "San Alberto", "San Javier", "San Justo", "Santa María",
    "Sobremonte", "Tercero Arriba", "Totoral", "Tulumba", "Unión",
  ],
  "Corrientes": [
    "Bella Vista", "Berón de Astrada", "Capital", "Concepción",
    "Curuzú Cuatiá", "Empedrado", "Esquina", "General Alvear",
    "General Paz", "Goya", "Itatí", "Ituzaingó", "Lavalle",
    "Mburucuyá", "Mercedes", "Monte Caseros", "Paso de los Libres",
    "Saladas", "San Cosme", "San Luis del Palmar", "San Martín",
    "San Miguel", "San Roque", "Santo Tomé", "Sauce",
  ],
  "Entre Ríos": [
    "Colón", "Concordia", "Diamante", "Federación", "Federal",
    "Feliciano", "Gualeguay", "Gualeguaychú", "Islas del Ibicuy",
    "La Paz", "Nogoyá", "Paraná", "San Salvador", "Tala",
    "Uruguay", "Victoria", "Villaguay",
  ],
  "Formosa": [
    "Bermejo", "Formosa", "Laishí", "Matacos", "Patiño",
    "Pilagás", "Pilcomayo", "Ramón Lista",
  ],
  "Jujuy": [
    "Cochinoca", "El Carmen", "Dr. Manuel Belgrano", "Humahuaca",
    "Ledesma", "Palpalá", "Rinconada", "San Antonio", "San Pedro",
    "Santa Bárbara", "Santa Catalina", "Susques", "Tilcara",
    "Tumbaya", "Valle Grande", "Yavi",
  ],
  "La Pampa": [
    "Atreucó", "Caleu Caleu", "Capital", "Catriló", "Chapaleufú",
    "Chical Co", "Chalileo", "Conhelo", "Curacó", "Guatraché",
    "Hucal", "Lihuel Calel", "Limay Mahuida", "Loventué", "Maracó",
    "Puelén", "Quemú Quemú", "Rancul", "Realicó", "Toay",
    "Trenel", "Utracán",
  ],
  "La Rioja": [
    "Arauco", "Capital", "Castro Barros", "Chamical", "Chilecito",
    "Coronel Felipe Varela", "Famatina", "General Ángel V. Peñaloza",
    "General Belgrano", "General Juan Facundo Quiroga",
    "General Lamadrid", "General Ocampo", "General San Martín",
    "Independencia", "Rosario Vera Peñaloza", "San Blas de los Sauces",
    "Sanagasta", "Vinchina",
  ],
  "Mendoza": [
    "Capital", "General Alvear", "Godoy Cruz", "Guaymallén",
    "Junín", "La Paz", "Las Heras", "Lavalle", "Luján de Cuyo",
    "Maipú", "Malargüe", "Rivadavia", "San Carlos", "San Martín",
  ...
  "Misiones": [
    ...
    "Oberá", "San Ignacio", "San Javier", "San Pedro",
    "Veinticinco de Mayo",
  ],
  "Neuquén": [
  ...
  "Río Negro": [
    "Adolfo Alsina", "Avellaneda", "Bariloche", "Conesa",
    "El Cuy", "General Roca", "Nueve de Julio", "Ñorquincó",
    "Pichi Mahuida", "Pilcaniyeu", "San Antonio", "Valcheta",
    "Veinticinco de Mayo",
  ],
  "Salta": [
    "Anta", "Cachi", "Cafayate", "Capital", "Cerrillos",
    "Chicoana", "General Güemes", "General José de San Martín",
    "Guachipas", "Iruya", "La Caldera", "La Candelaria",
    "La Poma", "La Viña", "Los Andes", "Metán", "Molinos",
    "Orán", "Rivadavia", "Rosario de la Frontera", "Rosario de Lerma",
    "San Carlos", "Santa Victoria",
  ],
  "San Juan": [
    "Albardón", "Angaco", "Calingasta", "Capital", "Caucete",
    "Chimbas", "Iglesia", "Jáchal", "Nueve de Julio", "Pocito",
  ...
  "San Luis": [
    ...
    "General Pedernera", "Gobernador Dupuy", "Junín",
    "La Capital", "Libertador General San Martín",
  ],
  "Santa Cruz": [
    "Corpen Aike", "Deseado", "Güer Aike", "Lago Argentino",
    "Lago Buenos Aires", "Magallanes", "Río Chico",
  ],
  "Santa Fe": [
    "Belgrano", "Caseros", "Castellanos", "Constitución",
    "Garay", "General López", "General Obligado", "Iriondo",
    "La Capital", "Las Colonias", "Nueve de Julio", "Rosario",
    "San Cristóbal", "San Javier", "San Jerónimo", "San Justo",
    "San Lorenzo", "San Martín", "Vera",
  ],
  "Santiago del Estero": [
    "Aguirre", "Alberdi", "Atamisqui", "Avellaneda", "Banda",
    "Belgrano", "Capital", "Copo", "Choya", "Figueroa",
    "General Taboada", "Guasayán", "Jiménez", "Juan F. Ibarra",
    "Loreto", "Mitre", "Moreno", "Ojo de Agua", "Pellegrini",
    "Quebrachos", "Río Hondo", "Rivadavia", "Robles", "Salavina",
  ...
  "Tucumán": [
    ...
    "Lules", "Monteros", "Río Chico", "Simoca", "Tafí del Valle",
    "Tafí Viejo", "Trancas", "Yerba Buena",
  ],
};

export const PROVINCIA_NAMES = Object.keys(PROVINCIAS).sort();
